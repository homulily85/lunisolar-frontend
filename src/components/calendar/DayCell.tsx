...
const DayCell = React.memo(function DayCell({
    ...
    const bgClass = isSelected ? 'bg-orange-200 dark:bg-orange-700' : 'bg-white dark:bg-gray-700';
    const textColor = (isSelected && isToday) ? 'text-black dark:text-white'
        : isToday ? 'text-orange-800 dark:text-orange-300'
            : isCurrentMonth ? 'text-black dark:text-white' : 'text-gray-500 dark:text-gray-400';
